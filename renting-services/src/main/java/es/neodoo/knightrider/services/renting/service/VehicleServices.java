...
public class VehicleServices {
	...
	VehicleBlockedDAO vehicleBlockedDAO;
	...
	public Vehicle getVehicleBlocked(String username) throws ServiceException {
	...
	public Vehicle getVehicletraveling(String username) throws ServiceException {
	...
	public boolean travelStart(String username, int vehicleId) throws VehicleIsNotAvailable, UserHasAnotherVehicleBlocked, ServiceException {
		...
		try {
			...
			if (vehicleBlocked.getVehicle().getId() == vehicleId | vehicle != null) { 
	...
	public boolean travelFinish(String username, int vehicleId) throws ServiceException {
		...
		try {
			...
			vehicleDAO.updateVehicleToUnblocked(vehicleId);
			finished = true;
			log.info("User" + username + "finish traveling with vehicle" + vehicleId);
